...
public class LogAspect {
    private Logger baseLog = LoggerFactory.getLogger("base");
    /**
    ...
    private void addOperationLog(JoinPoint joinPoint, Object res, long time) throws Exception {
        ...
        if(annotation != null){
            baseLog.info("注解LogAnnotation: " + JSON.toJSONString(annotation));
            ...
            baseLog.info("operationLog的getMethod方法测试： " + operationLog.getMethod());
        }
    }
}
